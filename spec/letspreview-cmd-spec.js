...
// describe('letspreview cmd', () => {
//   it('should return the full help message when the user fails to pass a command to execute.', (done) => {
//     execFile('node', ['src/letspreview'], (error, stdout, stderr) => {
//       expect(stdout).toBeFalsy();
//       expect(stderr.replace(/\s|\r?\n|\r/g, '')).toEqual('src/letspreview<cmd><name>[options]Commands:publish<name>[options]Pushestheapplicationtoletspreview.io.unpublish<name>[options]Removestheapplicationfromletspreview.io.GlobalOptions-v,--verboseDisplayDebuggingOutput[boolean]-h,--helpShowHelp[boolean]-q,--quietSuppressOutput[boolean]Youmustspecifyacommandtoexecute.');
//       done();
//     });
//   });
// });

// describe('letspreview publish cmd', () => {
//   // jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;

//   it('should return a missing argument error message when the user neglects to provide an application name.', (done) => {
//     execFile('node', ['src/letspreview', 'publish'], (error, stdout, stderr) => {
//       expect(stdout).toBeFalsy();
...
//     execFile('node', ['src/letspreview', 'publish', 'hello'], (error, stdout, stderr) => {
//       expect(stdout).toBeFalsy();
...
//     execFile('node', ['src/letspreview', 'publish', 'hello', '-k', 'invalid-key'], (error, stdout, stderr) => {
...
//     execFile('node', ['src/letspreview', 'publish', 'hello', '-k', process.env.key, '-d', 'spec-data'], (error, stdout, stderr) => {
//       expect(stderr).toBeFalsy();
...
// describe('letspreview unpublish cmd', () => {
//   // jasmine.DEFAULT_TIMEOUT_INTERVAL = 60000;

//   it('should return success when a correctly formatted unpublish command is passed.', (done) => {
//     execFile('node', ['src/letspreview', 'unpublish', 'hello', '-k', process.env.key], (error, stdout, stderr) => {
//       expect(stderr).toBeFalsy();
...
//     execFile('node', ['src/letspreview', 'unpublish', '-k', process.env.key], (error, stdout, stderr) => {
//       expect(stdout).toBeFalsy();
//       expect(stderr).toMatch(/Not enough non-option arguments: got 0, need at least 1/);
//       done();
//     });
...
//     execFile('node', ['src/letspreview', 'unpublish', 'invalid-name', '-k', process.env.key], (error, stdout, stderr) => {
//       expect(stderr).toBeFalsy();
...
//     execFile('node', ['src/letspreview', 'unpublish', 'hello'], (error, stdout, stderr) => {
//       expect(stdout).toBeFalsy();
//       expect(stderr).toMatch(/Missing required argument: key/);
//       done();
//     });
...
//     execFile('node', ['src/letspreview', 'unpublish', 'hello', '-k', 'invalid-key'], (error, stdout, stderr) => {
//       expect(stderr).toBeFalsy();
//       expect(stdout).toMatch(/Unauthorized/);
//       done();
//     });
